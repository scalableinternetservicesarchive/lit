...
# Lambda URIs are "{+lambda}/{+function}" e.g. "lit/ping".
# We also support path matching at the root e.g. "lit" but these require definining separate "_root" terraform resources.
