...
usage="Usage: deploy-ecs.sh [lit-app-web|lit-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/lit:$2"
...
aws ecs update-service --cluster lit \
  --no-cli-pager \
  --region "$ecs_region" \
