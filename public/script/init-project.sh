...
git clone https://github.com/rothfels/lit.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/lit/$SLUG/g" **/*.tf
sed -i.bak "s/lit/$SLUG/g" **/*.ts
sed -i.bak "s/lit/$SLUG/g" **/*.yml
sed -i.bak "s/lit/$SLUG/g" **/*.sh
sed -i.bak "s/lit/$SLUG/g" **/*.json
rm -rf **/*.bak
